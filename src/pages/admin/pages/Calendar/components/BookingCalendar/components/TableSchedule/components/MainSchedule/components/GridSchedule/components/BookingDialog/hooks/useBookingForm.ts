...
import {
	...
	type BookingSlot,
	bookingFormSchema,
} from "@/pages/admin/pages/Calendar/components/BookingCalendar/components/TableSchedule/components/MainSchedule/components/GridSchedule/schemas/bookingForm"

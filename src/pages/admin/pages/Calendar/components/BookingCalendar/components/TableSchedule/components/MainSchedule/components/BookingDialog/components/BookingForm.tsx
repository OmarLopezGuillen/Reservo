...
import { PaymentsSection } from "@/pages/admin/pages/Calendar/components/BookingCalendar/components/TableSchedule/components/MainSchedule/components/BookingDialog/components/PaymentsSection"
import { useBookingForm } from "@/pages/admin/pages/Calendar/components/BookingCalendar/components/TableSchedule/components/MainSchedule/components/BookingDialog/hooks/useBookingForm"
import type { BookingSlot } from "@/pages/admin/pages/Calendar/components/BookingCalendar/components/TableSchedule/components/MainSchedule/components/BookingDialog/schemas/bookingForm"
